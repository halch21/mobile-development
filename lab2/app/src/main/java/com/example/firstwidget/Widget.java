...
public class Widget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager manager, int[] ids){
        ...
        SharedPreferences pref = context.getSharedPreferences(Config.WIDGET_TEXT, Context.MODE_PRIVATE);
        for (int id: ids){
    ...
    public void onDeleted(Context context, int[] ids){
        ...
        SharedPreferences.Editor edit = context.getSharedPreferences(Config.WIDGET_TEXT, Context.MODE_PRIVATE).edit();
        for (int id: ids){
